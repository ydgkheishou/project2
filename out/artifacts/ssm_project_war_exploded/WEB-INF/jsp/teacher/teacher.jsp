...
<body style="background-color:#f2f9fd;">
	...
	<div class="leftnav">
		...
		<ul style="display:block">
			<li><a
<%--					target="right":表示在名为right的框架中打开页面--%>
					href="${pageContext.request.contextPath}/teacher.action?method=queryByPage"
					target="right"><span class="icon-caret-right"></span>学生查询</a></li>
			<li><a
				href="${pageContext.request.contextPath}/uploadServlet.action"
				target="right"><span class="icon-caret-right"></span>布置上传作业</a></li>
			<li><a
				href="${pageContext.request.contextPath}/servlet/ListFileServlet"
				target="right"><span class="icon-caret-right"></span>批改学生作业</a></li>
			<li><a
				href="${pageContext.request.contextPath}/teacher.action?method=queryGradeByPage"
				target="right"><span class="icon-caret-right"></span>上传学生成绩</a></li>
		</ul>
		<h2>
