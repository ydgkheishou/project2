...
<div class="header bg-main">
    <div class="logo margin-big-left fadein-top">
        <h1>
            <img src="${pageContext.request.contextPath }/images/admin.jpg"
...
<div class="leftnav">
    ...
    <ul style="display:block">
        <li><a
                href="${pageContext.request.contextPath}/admin/toAccountList"
                target="right"><span class="icon-caret-right"></span>账户管理</a></li>
        <li><a
                href="${pageContext.request.contextPath}/admin/toAddInfomation"
                target="right"><span class="icon-caret-right"></span>发布公告</a></li>

        <li><a
                href="${pageContext.request.contextPath}/admin/toAddCourse"
                target="right"><span class="icon-caret-right"></span>课程注册</a></li>
        <li><a
                href="${pageContext.request.contextPath}/admin/queryGradeByPage"
    ...
    <ul>
        <li><a
                href="${pageContext.request.contextPath}/toUpdateMe?userId=${sessionScope.admin.userid}"
